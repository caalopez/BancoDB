...
""")
    ...
    # # Lugar de Donación
        ...
        # 🔹 Llamar a predecir_donaciones para obtener modelo y predicciones
        modelo, predicciones = predecir_donaciones(df)

    # 🔹 Calcular RMSE correctamente usando el modelo entrenado
